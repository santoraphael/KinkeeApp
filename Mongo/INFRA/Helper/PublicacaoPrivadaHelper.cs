...
{
    public static class PublicacaoPrivadaHelper
    {
        public static List<PublicacaoModel> ListaDePosts()
        {
            var db = new Connection();
            var database = db.ConnectServer();
            var collection = database.GetCollection<PublicacaoModel>("FanClub.NewsFeed");
        ...
        public static ObjectId AddPublicacao(PublicacaoModel publicacao)
        {
            ...
            try
            {
                // Substitui o 'Save<PublicacaoModel>()' pela abordagem de upsert
